...
public class ProductServiceImpl implements ProductService {
    ...
    public List<ProductDto> findByCriteria(final Pageable pageable, final List<SearchCriteria> criteria) {
        ...
        return products.stream()
                .map(product -> {
                    ...
                    return currencyService.changeCurrency(productDto, sessionCurrencyWrapper.getCurrency());
                }).toList();
    }
    ...
    public ProductDto findById(final UUID id) {
        ...
        return currencyService.changeCurrency(mapper.toProductDto(product), sessionCurrencyWrapper.getCurrency());
    }
